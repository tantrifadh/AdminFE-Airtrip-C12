    ...
    <>
      ...
      >
        <div className="flex-row space-y-3 relative">
            ...
            <div className="flex justify-between">
                <label className="font-semibold pr-2">Saldo</label>
                <input className="border-2 border-blue-300/50 w-[75%] " type="text" />
            </div>
            <div className="flex justify-between">
                <label className="font-semibold pr-2">E-mail</label>
                <input className="border-2 border-blue-300/50 w-[75%] " type="text" />
            </div>
            <div className="flex justify-between">
                <label className="font-semibold pr-2">EncryptedPassword</label>
                <input className="border-2 border-blue-300/50 w-[75%] " type="text" />
            </div>
            <div className="flex justify-between">
                <label className="font-semibold pr-2">Verified</label>
                <input className="border-2 border-blue-300/50 w-[75%] " type="text" />
            </div>
            <div className="flex justify-between">Role ID
                <label className="font-semibold pr-2"></label>
                <input className="border-2 border-blue-300/50 w-[75%] " type="text" />
            </div>
            <div className="flex justify-between">
